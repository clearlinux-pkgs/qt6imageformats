...
Version  : 6.6.3
Release  : 13
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.3/submodules/qtimageformats-everywhere-src-6.6.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.3/submodules/qtimageformats-everywhere-src-6.6.3.tar.xz
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.6.3
cd %{_builddir}/qtimageformats-everywhere-src-6.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711482368
mkdir -p clr-build
pushd clr-build
