...
Version  : 6.7.3
Release  : 19
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtimageformats-everywhere-src-6.7.3.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.3/submodules/qtimageformats-everywhere-src-6.7.3.zip
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.7.3
cd %{_builddir}/qtimageformats-everywhere-src-6.7.3
pushd ..
cp -a qtimageformats-everywhere-src-6.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727831611
mkdir -p clr-build
pushd clr-build
