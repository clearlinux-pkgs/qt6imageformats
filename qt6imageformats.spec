...
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.1/submodules/qtimageformats-everywhere-src-6.6.1.tar.xz
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.6.1
cd %{_builddir}/qtimageformats-everywhere-src-6.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703021163
mkdir -p clr-build
pushd clr-build
