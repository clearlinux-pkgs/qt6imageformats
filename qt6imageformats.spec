...
Version  : 6.6.0
Release  : 3
URL      : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtimageformats-everywhere-src-6.6.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.0/submodules/qtimageformats-everywhere-src-6.6.0.tar.xz
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.6.0
cd %{_builddir}/qtimageformats-everywhere-src-6.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697483907
mkdir -p clr-build
pushd clr-build
