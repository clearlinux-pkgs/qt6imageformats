...
Version  : 6.7.2
Release  : 16
URL      : https://download.qt.io/official_releases/qt/6.7/6.7.2/submodules/qtimageformats-everywhere-src-6.7.2.zip
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.2/submodules/qtimageformats-everywhere-src-6.7.2.zip
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.7.2
cd %{_builddir}/qtimageformats-everywhere-src-6.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718932134
mkdir -p clr-build
pushd clr-build
