...
Source0  : https://download.qt.io/official_releases/qt/6.5/6.5.3/submodules/qtimageformats-everywhere-src-6.5.3.tar.xz
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.5.3
cd %{_builddir}/qtimageformats-everywhere-src-6.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696285493
mkdir -p clr-build
pushd clr-build
