...
Version  : 6.8.0
Release  : 21
URL      : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtimageformats-everywhere-src-6.8.0.zip
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtimageformats-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.8.0
cd %{_builddir}/qtimageformats-everywhere-src-6.8.0
pushd ..
cp -a qtimageformats-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732608641
mkdir -p clr-build
pushd clr-build
