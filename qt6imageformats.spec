...
Source0  : https://download.qt.io/official_releases/qt/6.7/6.7.1/submodules/qtimageformats-everywhere-src-6.7.1.zip
...
%prep
%setup -q -n qtimageformats-everywhere-src-6.7.1
cd %{_builddir}/qtimageformats-everywhere-src-6.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716946916
mkdir -p clr-build
pushd clr-build
